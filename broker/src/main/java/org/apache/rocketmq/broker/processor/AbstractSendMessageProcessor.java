...
public abstract class AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    /**
     * 构建trace的context，此处为message新增了两个属性，regionId以及trace_switch
     * @param ctx
     * @param requestHeader
     * @return
     */
    ...
    protected RemotingCommand msgCheck(final ChannelHandlerContext ctx,
        ...
        // 如果当broker不可写，同时topic为顺序消息的时候返回NO_PERMISSION
        ...
        // 如果收到的消息的topic为自动创建的topic，返回SYSTEM_ERROR
    ...
    /**
     * TODO 这里的request不需要再parse第二次，完全可以使用之前已经parse过的header
     * @param ctx
     * @param request
     * @param context
     */
